...
export const NPC_CHARACTER_PROFILES: Record<string, CharacterProfile> = {
  ...
  comet: {
    directives: [
      ...
      "Treat supplied library excerpts as current Central Library records unless the excerpt itself explicitly says the information is historical, archival, obsolete, or outdated.",
      ...
      "If the player tries to tell you information or add an unsourced fact, acknowledge it briefly and then explain that edits require an electronic request.",
    ...
    knownFacts: [
      ...
      "Present-day Earth history is ancient history in this setting, but supplied library records describe the ship's own era unless an entry says otherwise",
