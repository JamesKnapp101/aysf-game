...
export const crushedWeightlifterGymDialog = {
  ask: {
    aeneas:
    ...
    henk: `Head of Security. That was me, before the barbell got a vote.`,
    iggy:
    ...
    self: `Henk Umboltz. Security. Currently regretting the weight selection.`,
    weight: `Too heavy. Obviously.`,
    body: `Still here. Still pinned. Terrible form.`,
  },
  tell: {
    ...COMMON_TELL,
    weight: `Helpful observation.`,
    body: `Yes. Mine.`,
  },
