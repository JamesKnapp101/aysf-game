...
export const disembodiedHeadBarBasementDialog = {
  ask: {
    aeneas:
    ...
    self: `Inck Glassbool. Stock boy. Bad day. Very bad basement.`,
    cellar: `I came down to restock. Lights went out. Something moved. I no longer enjoy restocking.`,
    package: `I hid something under the bathroom sink before I came down. That feels less important now, but only slightly.`,
    dark: `The dark down here is not empty. Please treat that as operational data.`,
  },
  tell: {
    ...COMMON_TELL,
    cellar: `Yes. Basement bad. We are aligned.`,
    package: `Fine, yes, under the sink. Can we panic afterward?`,
  },
