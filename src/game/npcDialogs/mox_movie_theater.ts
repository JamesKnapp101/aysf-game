...
export const moxMovieTheaterDialog = {
  ask: {
    aeneas:
    ...
    mox: `Mox Eegler made the mind extractor. Which means we did. Which is very on-brand and a little upsetting.`,
    isosceles:
    ...
    self: `I think I am you, or a memory of you, which is either fascinating or extremely rude.`,
    movie: `The movie is useful because it recorded without understanding. Blind cameras sometimes catch what everyone else edits out.`,
    contamination: `The Shrew Nebula peppered the Aeneas with microscopic particles. I think that is where this started.`,
    "what to do": `Use the film as evidence. Find the pattern. Then get the reactor situation under control.`,
  },
  tell: {
    ...COMMON_TELL,
    movie: `Yes. The movie is a clue wearing ceremony clothes.`,
    contamination: `That fits. Tiny particles, huge consequences.`,
  },
