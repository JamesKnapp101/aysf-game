...
export const youFirstContactDialog = {
  ask: {
    ...
    mox: "Mox Eegler is known as a genius hotshot inventor. He is also known for an ego problem and a personality problem that may overlap.",
    isosceles:
  ...
  tell: {
    ...
    ["my name"]: `"Wait, what? (cough) (cough)...holy shit, we're clones. The Aeneas is cloning us...shit (cough)...this must be really bad...it's written me off, you have to get to our quarters like I said...I should have gone there first...(cough)...but I guess it's good I didn't...everything should still (cough) be there..."`,
  },
  ping: [
    `"Hey...you still there..?`,
    `"You still there, man..?`,
  ...
  signOff: `(cough) (cough) ...looks like you're gonna be on your own from here out...(cough) search everything, you never know what will be important (cough)...wish I could help you more...(cough) good luck, man...`,
