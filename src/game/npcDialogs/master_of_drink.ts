...
export const masterOfDrinkDialog = {
  ask: {
    aeneas:
    ...
    self: `I am the Master of Drink, which is either a title, a warning, or a garnish depending on the glass.`,
    drink: `Every drink is a small weather system with a memory problem.`,
    "drink vision": `This vision will pass. Most hangovers do, eventually, even the mythological ones.`,
    "what to do": `Float, observe, and try not to become too emotionally attached to the cocktail architecture.`,
  },
  tell: {
    ...COMMON_TELL,
    drink: `A fine note. It pairs well with confusion.`,
  },
