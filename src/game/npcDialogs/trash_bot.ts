...
export const trashBotDialog = {
  ask: {
    aeneas: `The Aeneas is a ship. Ships remain nicer when residents do not litter on them.`,
    mayor:
    ...
    park: `Vivarium Park is more enjoyable when debris is placed in approved receptacles.`,
    gym:
    ...
    self: `Sweepy collects trash. Sweepy is fulfilled by responsible disposal.`,
    trash: `Trash belongs in the trashcan. This is not merely advice. It is civilization.`,
  },
  tell: {
    ...COMMON_TELL,
    trash: `Thank you for supporting responsible waste management.`,
  },
