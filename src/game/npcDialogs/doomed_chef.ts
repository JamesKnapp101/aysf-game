...
export const doomedChefDialog = {
  ask: {
    ...
    self: `Matthias Venn. Head Chef. Was.`,
    freezer: `Freezer on. Keeps me. Close door. Turn off. End it.`,
    cooking: `My dishes. Perfect. Controversial. Worth it.`,
    contamination: `Meat was wrong. Heat made worse. Cold slowed it.`,
    reactor: `Reactor hot. Bad. Heat feeds thing. Maybe ends all.`,
    "what to do": `Close door. Freezer off. Do not come in dark.`,
  },
  tell: {
    ...COMMON_TELL,
    freezer: `Yes. Freezer off. Please.`,
    cooking: `Good food. Bad end.`,
  },
