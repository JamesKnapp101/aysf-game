...
export const spotBotDialog = {
  ask: {
    ...
    gym: `Ultra Fitness is the temple, bro. Weights, machines, cardio if you must, and gains if you respect the process.`,
    bar:
    ...
    mox: `You came through here once in a flowered robe, bro. Confidence level, dangerous.`,
    isosceles:
    ...
    self: `Bro, I am your spotter, your motivator, your emergency hype machine. I also know every muscle you are neglecting.`,
    workout: `Start where your form does not betray you, bro. Then build. Then hydrate. Then build again.`,
    weight: `That weight is occupied, bro. The guy under it is still giving max-effort energy and I respect the grind.`,
    body: `That body under the weight is not Freeny Salk, bro. Looks like you, which is not usually how leg day goes.`,
    "insta roids": `Freeny Salk used insta-roids. Fast strength, bad judgment, classic locker-room tragedy, bro.`,
  },
  tell: {
    ...COMMON_TELL,
    body: `Bro, that is a heavy truth under a heavier bar.`,
    "insta roids": `Roids are not the way, bro. Unless the way is toward consequences.`,
  },
