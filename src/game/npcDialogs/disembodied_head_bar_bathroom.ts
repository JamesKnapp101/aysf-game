...
export const disembodiedHeadBarBathroomDialog = {
  ask: {
    aeneas:
    ...
    bar: `The Loosened Tongue is a good place to work if you enjoy errands, secrets, and not asking follow-up questions.`,
    restaurant:
    ...
    mox: `I know who you are, Mox. Everybody at the bar kind of does.`,
    isosceles:
    ...
    self: `Inck Glassbool. Stock boy. Completely normal bathroom user. Nothing suspicious happening.`,
    package: `What package? There is no package. Hypothetically, under-sink storage is not a crime by itself.`,
  },
  tell: {
    ...COMMON_TELL,
    package: `I deny everything, especially if you are correct.`,
  },
