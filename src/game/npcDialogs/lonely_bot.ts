...
export const lonelyBotDialog = {
  ask: {
    ...
    "what happened": `I heard announcements, commotion, then almost nothing. I wish that answer were more useful.`,
    self: `I'm just a robot who hid when they wanted to recycle me. I have had a long time to practice being quiet.`,
    contamination: `I noticed pinholes in walls and floors. I think something tiny came through the ship, but I cannot prove it.`,
    dark: `I saw something in the dark living quarters. It was not human, and it was not a robot I recognized.`,
    warehouse: `The warehouse has been safer than most places, as long as nobody official remembers I exist.`,
    whistle: `A certain whistle frequency usually means a friend, or at least someone who knows the right friend.`,
  },
  tell: {
    ...COMMON_TELL,
    whistle: `That whistle matters. It tells me the visit is not a recycling appointment.`,
    warehouse: `The warehouse is not much of a home, but it has been mine for a long time.`,
  },
