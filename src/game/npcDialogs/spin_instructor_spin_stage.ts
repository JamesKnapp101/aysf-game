...
export const spinInstructorSpinStageDialog = {
  ask: {
    aeneas:
    ...
    self: `The instructor's reconstruction stutters with a bright, prerecorded fitness smile.`,
    workout: `Keep pedaling, keep breathing, and do not let catastrophic electrical failure define your form.`,
  },
  tell: {
    ...COMMON_TELL,
    workout: `The reconstruction gives a frozen thumbs-up.`,
  },
