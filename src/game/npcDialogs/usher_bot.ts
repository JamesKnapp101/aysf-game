...
export const usherBotDialog = {
  ask: {
    ...
    rotations: `Each Journey Home film commemorates a rotation. In cinematic terms, it is sequel structure as civic ritual.`,
    transfers:
    ...
    "movie theater": `The Movphitheater is a dome-projection venue. Please respect the picture, the seats, and the no-smoking signage.`,
    storage:
    ...
    self: `Ush, house usher, film appreciator, rule enforcement in a tasteful lobby finish.`,
    movie: `Our Journey Home: Chapter 542 is currently playing. It follows the usual template, but the content seems troubling this time.`,
    otto: `Otto is the AI that makes the Journey Home films. Singular vision, strict template, obsessive continuity.`,
    smoking: `Smoking in the bathroom is prohibited. Cinema history is full of villains, but very few are as disappointing as bathroom smokers.`,
    bathroom: `The bathroom is west of the lobby. Please do not use it as a personal fog machine.`,
  },
  tell: {
    ...COMMON_TELL,
    smoking: `If there is bathroom vapor, report it clearly. I take the sanctity of signage very seriously.`,
    bathroom: `The bathroom is not a subplot. It is a facility with rules.`,
  },
