...
export const moxStairBottomDialog = {
  ask: {
    aeneas:
    ...
    self: `I think I'm Mox. I also think gravity is about to win this argument.`,
    "what to do": `Get the power back on, recycle the reactor, and do not trust dark places.`,
    dark: `The dark has something in it now. That is not poetry, that is advice.`,
    reactor: `The reactor matters. I would be more specific, but I am falling down a stairwell.`,
  },
  tell: {
    ...COMMON_TELL,
    dark: `Yes. Avoid the dark. I am briefly very committed to simple wisdom.`,
  },
