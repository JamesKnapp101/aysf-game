...
export const nailBotDialog = {
  ask: {
    ...
    isosceles: `Miss Onche is glamorous, chaotic, and very good for business. People talk when she walks by.`,
    volonope:
    ...
    iggy: `Iggy belongs to Miss Onche, and that cat has better social instincts than half the waking population.`,
    badge:
    ...
    self: `NailBot, darling. Manicures, pedicures, gossip acquisition, emotional exfoliation.`,
    gossip: `Gossip is social currency, emergency lighting, and seasoning. Bring me something juicy and I may remember something useful.`,
    whistle: `Do not lung-shame me. You do not need lungs to blow. I will not be taking follow-up questions.`,
    warehouse: `I know of a poor little robot hiding near the warehouse, but a lady does not simply hand out secrets without tea.`,
  },
  tell: {
    ...COMMON_TELL,
    gossip: `That is a start, honey. Bring me something with teeth and I might give you something back.`,
    ["horny clone"]: `Oh, that is delicious. I may have something equally useful for you.`,
    whistle: `Again with the whistle. You do not need lungs to blow, and I refuse to elaborate.`,
  },
