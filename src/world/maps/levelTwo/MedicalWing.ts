...
export const medicalWingRooms: Room[] = [
  ...
  },
  {
    ...
    exits: [
      { direction: "south", doorId: "LabDoors" },
  ...
  },
  {
    ...
    exits: [
      { direction: "west", toRoomId: "SpecimenOne" },
      { direction: "north", toRoomId: "SpecimenTwo" },
      { direction: "east", toRoomId: "SpecimenThree" },
      { direction: "south", toRoomId: "SpecimenFour" },
    ],
  },
  {
    id: "SpecimenOne",
    name: "Xenobiology Lab: Specimen One",
    description: `This is where specimen one will live.`,
    exits: [{ direction: "east", toRoomId: "XenobiologyLab" }],
  },
  {
    id: "SpecimenTwo",
    name: "Xenobiology Lab: Specimen Two",
    description: `This is where specimen two will live.`,
    exits: [{ direction: "south", toRoomId: "XenobiologyLab" }],
  },
  {
    id: "SpecimenThree",
    name: "Xenobiology Lab: Specimen Three",
    description: `This is where specimen three will live.`,
    exits: [{ direction: "west", toRoomId: "XenobiologyLab" }],
  },
  {
    id: "SpecimenFour",
    name: "Xenobiology Lab: Specimen Four",
    description: `This is where specimen four will live.`,
    exits: [{ direction: "north", toRoomId: "XenobiologyLab" }],
  },
  {
    id: "Lab",
    name: "Lab",
