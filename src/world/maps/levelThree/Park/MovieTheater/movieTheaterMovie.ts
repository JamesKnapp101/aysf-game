...
export const MOVIE_THEATER_MOVIE_SEGMENTS: MovieSegment[] = [
  ...
  },
  {
    ...
    stages: [
      ...
      `"A potential new lifeform? If so it will mark the fifth new alien species discovered, but either way the microscopic particles found to be the cause of the clustered pinholes seen around the ship are certainly new, but are they alive? And more importantly, are they safe?"\n\nThe holographic window above the audience cuts to shaky cam footage running down a hallway where the floor is smeared with blood, and some kind of slime. The camera turns to see a short, dark haired man, his eyes scared. The light flickers, just for a second, but that second he was in darkness somehow transformed him into a melting stick figure, clothes draping off of him.\n\n"Stay tuned!"`,
      `"In record time, scientists created a new device called the 'Eegler Box' capable of receiving and measuring the mysterious signal that originated from the SNN-9 Shrew Nebula, the nature of which, they determined, was not a traditional communication signal but rather an example of 'quantum superposition encoding', meaning the signal exists in all possible states simultaneously, and each time they attempt to measure it in any way it frustratingly collapses into a different, meaningless signal..."`,
    ],
  },
  {
