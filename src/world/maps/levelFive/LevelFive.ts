  ...
  rooms: [
    {
      ...
      exits: [
        { direction: "east", toRoomId: "MainReactorPlatform" },
        // west is blocked: "You'll never be able to squeeze through the gap."
      ],
    },
    {
      id: "MainReactorPlatform",
      name: "Main Reactor Platform",
      description:
        "This is a large area which is devoted to the ship's engineering; there is a myriad of machinery, mainframes, monitors, and all manner of modern multifarious mechanisms merging into a mighty monolithic monstrosity mounted above, consisting of a mammoth apparatus surrounded on all sides by a maze of wiring, pipes, and ducts which cross the room and disappear into the wall to the west. On the western wall is a featureless door with some kind of proximity scanner next to it. The scanner has a violet strip across the top of it. Positioned in one corner is a slightly raised violet disk, four feet in diameter, which is made of some kind of glassy substance. Mounted above the door is a panel which is lit up red bearing a radiation symbol.",
      exits: [
        { direction: "west", toRoomId: "ReactorRoom" },
    ...
    },
    {
      ...
      exits: [
        ...
        { direction: "west", toRoomId: "MainReactorPlatform" },
      ],
    },
    {
      id: "EngCorridorThree",
