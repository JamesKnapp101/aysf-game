...
const FIRST_RADIO_CALL_MESSAGE = `*pop* "Yes, I'm here...holy shit I thought I was the last one...(heavy breathing) Look, I don't have much time here so listen up (cough). My name is Mox Eegler, and I wish I had more time to explain but I don't, you're gonna have to trust me (cough). Go to my quarters on level three, I've got some things there that will help you, just go into the bedroom, and turn the lamp on the wall in there. There's a DNA reader there that will help you identify bodies, and a memory extractor that you can use to hopefully get some answers. Take anything you need, shit has gone sideways, and you have to set things right before it's too late. I think you might be the last one alive. (cough cough) There's something in here with us, but that's the least of your worries...the power is out...and the reactor...is unstable..." The voice goes quite for a few seconds, then you hear him groan. "Sorry...but if you got anything you wanna ask me...or tell me...you better do it quick, pal..." *pop*`;
